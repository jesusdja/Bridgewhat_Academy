...
import 'package:academybw/widgets_shared/dropdownButton_generic.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    styleTextField = AcademyStyles().stylePrimary(size: sizeH * 0.02,color: AcademyColors.primaryGreyApp,fontWeight: FontWeight.bold);
    ...
    return InkWell(
      child: Container(
        ...
        child: Text('I already have an account',
          style: AcademyStyles().stylePrimary(color: AcademyColors.primary,size: sizeH * 0.02,textDecoration: TextDecoration.underline,fontWeight: FontWeight.bold),
          textAlign: TextAlign.left),
      ),
      onTap: (){
